...
public class machineFeatures {
    ...
    public void seeLocation(Location location) {
        System.out.println("ATM Location is: ");
        System.out.println("_________________________________________");
        System.out.println("1. Contry: " + location.getCountry());
        System.out.println("2. Zipcode: " + location.getZipCode());
        System.out.println("3. State: " + location.getState());
        System.out.println("4. City: " + location.getCity());
        System.out.println("5. Address: " + location.getAddress());
        System.out.println("6. Zone: " + location.getZone());
        System.out.println("____________________________________________");
    }
    ...
    public void withdraw(int amount, User user, ATM atm) {
        if (amount > user.getBalance()) {
            Transaction transaction = new Transaction(12334L, LocalDateTime.now(), amount, Verdict.FAILURE,
                    TransactionType.FAILED, atm.getLocation());
        ...
        if (amount > atm.getBalance()) {
            Transaction transaction = new Transaction(12335L, LocalDateTime.now(), amount, Verdict.OUT_OF_MONEY,
                    TransactionType.FAILED, atm.getLocation());
            atm.getTransactions().add(transaction);
        ...
        Transaction transaction = new Transaction(12336L, LocalDateTime.now(), amount, Verdict.SUCESS,
                TransactionType.DEBIT, atm.getLocation());
        atm.getTransactions().add(transaction);
