...
public class Game {
    ...
    public void play() {
        ...
        while (!gameOver) {
            ...
            board.matrix[row][col] = players[turn].getPlayerSymblo();
            ...
            turn = (turn + 1) % 2; // logic to set the turn
            printBoardConfig();
            // if(trun =0){ turn =1;} //Another way to set the turn
            // else{turn = 0}
        }
    }
    ...
    public int getIndex() {
        while (true) {
            ...
            int pos = scn.nextInt() - 1; // Bcz idx start from zero
